...
SERVICE_ACCOUNT_FILE = './project/credentials/bustling-vim-415105-83d345abec9e.json' #[개별입력] 파일명 : json key file명
"""
    ...
    for item in data:
        ...
        response = openai.chat.completions.create(
            ...
            messages=[{"role": "system", "content": 
                        ...
                        """}, 
                        {"role": "user", "content": text}], temperature=0, max_tokens=2000)
...
if __name__ == '__main__':
    ...
    print(f"분석에 소요된 총 시간: {total_time:.2f}초")