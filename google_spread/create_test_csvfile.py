...
# 원본 CSV 파일 경로 
input_file = 'C:/Users/selena/songmac/Project-DataLabelling-Automation/ignore/data/pos_test_5000.csv'# 저장할 새 CSV 파일 경로
output_file = 'C:/Users/selena/songmac/Project-DataLabelling-Automation/ignore/data/pos_test_3.csv'
